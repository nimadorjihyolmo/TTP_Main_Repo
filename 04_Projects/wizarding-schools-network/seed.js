...
const { Student, WizardingSchool } = require('./server/db/index');
...
const wizardingSchools = [
  {
    ...
    imageUrl: "https://i.ibb.co/30JYJkB/hogwarts.webp",location: "Hogwarts Castle, Highlands, Scotland, Great Britain",
    description:
